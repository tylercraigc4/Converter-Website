...
def testme(request):
    ...
    type1 = request.POST.get('type1', 'me')
    type2 = request.POST.get('type2', 'me')
    num1 = request.POST.get('num1', 1)
    userAnswer = request.POST.get('userAnswer', 1)
...
def add(request):
    ...
    value1 = request.POST.get('type1')
    value2 = request.POST.get('type2')
